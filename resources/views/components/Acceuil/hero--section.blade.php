<section class="max-w-8xl mx-auto px-6 md:px-12 lg:px-10 py-6 md:py-24 lg:py-12">
    <div class="flex flex-col lg:flex-row items-center gap-12 lg:gap-20 opacity-0 translate-y-2 animate-[fadeUp_400ms_ease-out_forwards]">
        <div class="flex flex-col gap-8 flex-1 text-center lg:text-left">
            ...
            <div class="flex flex-col gap-4">
                ...
                <p class="text-lg md:text-xl text-slate-600 leading-relaxed max-w-2xl mx-auto lg:mx-0">
                    Je construis des applications web évolutives avec un souci d'expérience utilisateur et de code
                    propre. Je suis spécialisé dans la transformation de problèmes complexes en solutions digitales
                    élégantes.
                </p>
            </div>
        ...
        <div class="flex-1 w-full max-w-md lg:max-w-[25vw] relative">
            ...
            <div
                ...
                <img alt="Alex Portfolio Photo"
                    ...
                    src="{{ asset('Gemini_Generated_Image_o0n92ho0n92ho0n9.png') }}" />
            </div>
            <div
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <p class="text-sm font-bold">5+ Years</p>
